...
export const Genre = (argument) => {
	...
	let url1 = `https://api.rawg.io/api/games?key=${API_KEY}&genres=${argument}`;
	...
	const RenderPublishers = async () => {
      ...
      <h1 class="title-white" style="margin-left:45px; margin-bottom: 30px"> Tous les titres avec le genre <span class="text-underline"> ${transString(
				argument
			)} </span>  </h1>
      `;
